...
class Grafo:
  ...
  def teste(self, distancia, vertice):
    ...
    3)
    (2 pontos) Implemente uma função que verifica se o grafo é Euleriano (ou seja, que possui um ciclo Euleriano), 
    retornando true ou false. Caso a resposta seja false, a sua função deve informar ao usuário todas as condições que não foram satisfeitas.
